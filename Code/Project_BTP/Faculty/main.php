                    ...
                    <div class="span3">
                        <div class="sidebar">
                            <ul class="widget widget-menu unstyled">
                                ...
                                <li><a href="studentable.php"><i class="menu-icon icon-inbox"></i>Course Info</a></li>
                    ...
                    <div class="span9">
                        <div class="content">
                            <div class="btn-controls">
                                ...
                                <div class="btn-box-row row-fluid">
                                    <a href="usertable.php" class="btn-box big span4"><i class="icon-wrench"></i>
                                        <p class="text-muted">
                                            Under Construction</p>
                                    </a><a href="studentable.php" class="btn-box big span4"><i class="icon-wrench"></i>
                                        <p class="text-muted">
                                            Under Construction</p>
                                    </a>
                                    </a><a href="#" class="btn-box big span4"><i class="icon-wrench"></i>
                                        <p class="text-muted">
                                            Under Construction</p>
                                    </a>
                                </div>
