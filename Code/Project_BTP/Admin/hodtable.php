                            ...
                            <div class="module">
                                ...
                                <div class="module-body table">
                                    <table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped	 display"
                                        ...
                                        <?php
                                        $sql = "SELECT HOD.H_id,User.F_name,User.L_name,HOD.Sem_no,HOD.Department FROM User,Faculty,HOD Where HOD.F_id=Faculty.F_id AND Faculty.U_id=User.U_id";
